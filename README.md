...
- [x] Activity calendar view — month grid where each day shows activities (distance, pace, HR), clickable to detail page
- [ ] Parser unit tests (validate .fit and .gpx output)
- [x] Shoe tracking — accumulated km, pace trend, and retirement alert per shoe
